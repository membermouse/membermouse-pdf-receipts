...
class MemberMouse_Receipt {
    ...
    protected function setData($data) {
        ...
        $this->date_paid = $data['order_date'];
...
?>
        ...
        <head>
            ...
            <link rel="stylesheet" href="<?php echo plugin_dir_path(__FILE__) . 'css/receipt.css'; ?>">
        </head>
                ...
                <div class="row receipt-table">
                    <div class="receipt-top">
                        <div class="receipt-info">
                            <div>
                                <strong><?php echo _mmpdft("MEMBER ID"); ?>:</strong> <?php echo $this->member_id; ?>
                            </div>
                            <br /> <br />
                        ...
                        <div class="receipt-date">
                            <div>
                                <strong><?php echo _mmpdft("DATE PAID"); ?>:</strong> <?php echo date('m-d-Y', strtotime($this->date_paid)); ?>
                            </div>
                        </div>
                    </div>
